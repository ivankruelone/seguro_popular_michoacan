...
class CI_DB_active_record extends CI_DB_driver {
	 ...
	 * @return	object
	 */
	public function insert_batch($table = '', $set = NULL, $replace = false)
	{
		if ( ! is_null($set))
		{
		...
		for ($i = 0, $total = count($this->ar_set); $i < $total; $i = $i + 100)
		{
			...
			$sql = $this->_insert_batch($this->_protect_identifiers($table, TRUE, NULL, FALSE), $this->ar_keys, array_slice($this->ar_set, $i, 100), $replace);
