...
// a.preciosinser * r.cantidadsurtida as importecondescuento, a.iva, a.preciosinser * r.cantidadsurtida + iva as total                                                
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo anchor('metro/remisionar/'.$row->perini.'/'.$row->perfin.'/'.$row->cvecentrosalud.'/'.$row->cvesuministro.'/'.$row->tiporequerimiento.'/'.$row->idprograma, 'Generar remision', array('class' => 'generaRemision')); ?></td>
                                                </tr>
