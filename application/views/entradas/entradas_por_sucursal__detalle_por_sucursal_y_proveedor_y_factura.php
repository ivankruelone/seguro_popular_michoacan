                                    ...
                                    <table id="ventas-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><?php echo anchor('entradas/entradas_por_sucursal__detalle_por_sucursal_y_proveedor_y_factura_y_productos/'.$sucursal.'/'.$row->proveedor.'/'.$row->entrada.'/'.$fecha1.'/'.$fecha2, '<i class="icon-plus"></i>', array('class' => 'green')); ?></td>
                                            </tr>
                                            <?php 
