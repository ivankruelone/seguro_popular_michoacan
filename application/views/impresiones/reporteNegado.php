...
$tabla = "<table cellpadding=\"1\">
    <tbody>
        <tr>
            ...
            <td style=\"width: 10%; text-align: right; \">".number_format($row->negado, 0)."</td>
        </tr>
    </tbody>
    </table>";
    
    $negado = $negado + $row->negado;
...
<table>
        ...
        <tr>
            <td colspan=\"4\" style=\"text-align: right; width: 90%; \">TOTAL</td>
            <td style=\"text-align: right; width: 10%; \"><b>".number_format($negado,0)."</b></td>
        </tr>
        </tfoot>
        </table>";
...
$pdf->Output('reporteNegado_'.$fecha1.'_'.$fecha2.'_'.date('ymdHis').'.pdf', 'D');
