...
$tabla = "<table cellpadding=\"1\">
    <tbody>
        <tr>
            ...
            <td style=\"width: 19%;\">".$row->completo."</td>
            <td style=\"width: 6%; text-align: right; \">".number_format($row->precio, 2)."</td>
            <td style=\"width: 6%; text-align: right; \">".number_format($row->canreq, 0)."</td>
            <td style=\"width: 6%; text-align: right; \">".number_format($row->cansur, 0)."</td>
        </tr>
    </tbody>
    </table>";
