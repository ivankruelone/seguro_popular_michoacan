							<div class="row-fluid">
                                <div class="span12">
                                    ...
                                    <p><?php echo anchor('inventario/imprimeInventarioByPasillo/'.$pasilloID, 'Imprimir inventario', array('target' => '_blank')); ?></p>
                                    ...
                                    <table class="table table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo anchor('inventario/asigna_ubicacion/'.$row->inventarioID, $row->pasilloID.'-'.$row->moduloID.'-'.$row->nivelID.'-'.$row->posicionID); ?></td>
