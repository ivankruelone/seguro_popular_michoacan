...
<?php
    echo MY_form_open('captura/electronica_valida');
...
<table>
    <caption id="tipo">Escanea el codigo de barras de tu receta.</caption>
    <tr>
        <td>Sucursal: <span style="color: red;"><?php echo $this->session->userdata('clvsucursal') . ' - ' .$this->session->userdata('sucursal'); ?></span></td>
        <td> Usuario: <span style="color: red;"><?php echo $this->session->userdata('usuario'); ?></span> - <?php echo date('Y-m-d H:i:s'); ?></td>
    </tr>
